...
public class StubGenesisConfigOptions implements GenesisConfigOptions {
  ...
  private OptionalLong parisForkBlockNumber = OptionalLong.empty();
  ...
  public StubGenesisConfigOptions parisForkBlock(final long blockNumber) {
    parisForkBlockNumber = OptionalLong.of(blockNumber);
    return this;
  }
