...
/**
 * Plugin interface for protocol management functionality.
 * This interface mirrors the ProtocolManager interface for plugin implementations.
 */
public interface PluginProtocolManager extends AutoCloseable {
