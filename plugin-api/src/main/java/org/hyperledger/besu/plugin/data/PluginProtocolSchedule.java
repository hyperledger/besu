...
/**
 * Plugin interface for protocol schedule functionality.
 * This interface mirrors the ProtocolSchedule interface for plugin implementations.
 */
public interface PluginProtocolSchedule {
