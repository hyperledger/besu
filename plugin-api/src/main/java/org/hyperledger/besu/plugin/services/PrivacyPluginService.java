...
public interface PrivacyPluginService extends BesuService {
  ...
  PrivateMarkerTransactionSigner getPrivateMarkerTransactionSigner();

  void setPrivateMarkerTransactionSigner(
      PrivateMarkerTransactionSigner privateMarkerTransactionSigner);
}
