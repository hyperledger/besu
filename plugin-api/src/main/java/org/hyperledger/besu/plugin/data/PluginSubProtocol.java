...
/**
 * Plugin interface for sub-protocol functionality.
 * This interface mirrors the SubProtocol interface for plugin implementations.
 */
public interface PluginSubProtocol {
