...
public final class CodeV1Validation {
  ...
  static final OpcodeInfo[] OPCODE_INFO = {
    ...
    OpcodeInfo.terminalOpcode("RJUMP", 0x5c, 0, 0, -3),
    OpcodeInfo.validOpcode("RJUMPI", 0x5d, 1, 0, 3),
    OpcodeInfo.validOpcode("RJUMPV", 0x5e, 1, 0, 2),
    ...
    OpcodeInfo.validOpcode("CALLF", 0xb0, 0, 0, 3),
    OpcodeInfo.terminalOpcode("RETF", 0xb1, 0, 0, -1),
