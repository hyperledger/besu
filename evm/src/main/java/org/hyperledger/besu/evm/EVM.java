      ...
      try {
        result =
            switch (opcode) {
              ...
              case 0x06 -> ModOperationOptimized.staticOperation(frame);
              case 0x07 -> SModOperationOptimized.staticOperation(frame);
              case 0x08 -> AddModOperationOptimized.staticOperation(frame);
              case 0x09 -> MulModOperationOptimized.staticOperation(frame);
