...
class ExchangeOperationTest {
  ...
  void testExchange_basicOperation() {
    ...
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(2));
    assertThat(frame.getStackItem(2)).isEqualTo(UInt256.fromInt(3));
    assertThat(frame.getStackItem(3)).isEqualTo(UInt256.fromInt(4));
    ...
    assertThat(frame.getStackItem(0)).isEqualTo(UInt256.fromInt(1));
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(2));
    assertThat(frame.getStackItem(2)).isEqualTo(UInt256.fromInt(4)); // was 3
    assertThat(frame.getStackItem(3)).isEqualTo(UInt256.fromInt(3)); // was 4
  ...
  void testExchange_immediate0xd0() {
    ...
    assertThat(frame.getStackItem(1).intValue()).isEqualTo(2);
    assertThat(frame.getStackItem(19).intValue()).isEqualTo(20);
    ...
    // After: swapped
    assertThat(frame.getStackItem(1).intValue()).isEqualTo(20);
    assertThat(frame.getStackItem(19).intValue()).isEqualTo(2);
  }
  ...
  void testExchange_endOfCode() {
    ...
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(2));
    assertThat(frame.getStackItem(29)).isEqualTo(UInt256.fromInt(30));

    final OperationResult result = operation.execute(frame, null);

    assertThat(result.getHaltReason()).isNull();
    // Verify swap
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(30));
    assertThat(frame.getStackItem(29)).isEqualTo(UInt256.fromInt(2));
  }
  ...
  void testSpecVector_exchange_e801() {
    ...
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(1));
    assertThat(frame.getStackItem(2)).isEqualTo(UInt256.ZERO); // bottom
    ...
    assertThat(frame.getStackItem(0)).isEqualTo(UInt256.fromInt(2)); // unchanged
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.ZERO); // swapped
    assertThat(frame.getStackItem(2)).isEqualTo(UInt256.fromInt(1)); // swapped
  }
  ...
  void testSpecVector_exchange30Items() {
    ...
    assertThat(frame.getStackItem(0)).isEqualTo(UInt256.fromInt(2)); // top
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(99));
    assertThat(frame.getStackItem(29)).isEqualTo(UInt256.fromInt(1)); // bottom
    ...
    assertThat(frame.stackSize()).isEqualTo(30);
    assertThat(frame.getStackItem(0)).isEqualTo(UInt256.fromInt(2)); // unchanged
    assertThat(frame.getStackItem(1)).isEqualTo(UInt256.fromInt(1)); // was 99, now 1
    assertThat(frame.getStackItem(29)).isEqualTo(UInt256.fromInt(99)); // was 1, now 99
  }
