...
public class KZGPointEvalPrecompileContractTest {
  ...
  public void happyPath() {
    ...
    Bytes32 fieldElementsPerBlob = Bytes32.wrap(Bytes.of(CKZG4844JNI.getFieldElementsPerBlob()).xor(Bytes32.ZERO));
    Bytes32 blsModulus = Bytes32.wrap(Bytes.of(CKZG4844JNI.BLS_MODULUS.toByteArray()));
