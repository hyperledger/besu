...
public class ExtDelegateCallOperationTest {
  ...
  public static final Code LEGACY_CODE =
      EOF_EVM.getCodeUncached(FullBytecode.of(ExtDelegateCallOperation.OPCODE, 1));
  ...
  public static final Code SIMPLE_LEGACY =
      EOF_EVM.getCodeUncached(FullBytecode.fromHexString("0x00"));
  public static final Code EMPTY_CODE = EOF_EVM.getCodeUncached(FullBytecode.fromHexString(""));
