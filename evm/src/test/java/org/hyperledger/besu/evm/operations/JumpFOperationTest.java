...
class JumpFOperationTest {
  ...
  void jumpFMissingCodeSection() {
    ...
    assertThat(jumpFResult.getHaltReason()).isEqualTo(ExceptionalHaltReason.CODE_SECTION_MISSING);
    assertThat(jumpFResult.getPcIncrement()).isEqualTo(1);
  ...
  void jumpFTooMuchStack() {
    ...
    assertThat(jumpFResult.getHaltReason()).isEqualTo(ExceptionalHaltReason.JUMPF_STACK_MISMATCH);
    assertThat(jumpFResult.getPcIncrement()).isEqualTo(1);
