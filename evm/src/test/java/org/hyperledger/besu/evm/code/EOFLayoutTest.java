...
public class EOFLayoutTest {
  ...
  public static Collection<Object[]> subContainers() {
    return Arrays.asList(
        new Object[][] {
          {
            "EF0001 010004 0200010001 0300010014 ff0000 00 00800000 FE EF00010100040200010001ff00000000800000FE",
            "no data section, one code section, one subcontainer",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 0300010014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)",
            "evmone - one container",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 0300010014 ff0003 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00) 000000",
            "evmone - one container two bytes",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 030003001400140014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)",
            "evmone - three subContainers",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 030003001400140014 ff0003 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00) ddeeff",
            "evmone - three subContainers and data",
            null,
            1
          },
          {
            "EF00 01 01000C 020003000100010001 030003001400140014 ff0003 00 008000000000000000000000 00 00 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00) ddeeff",
            "evmone - three subContainers three code and data",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 0300010100 ff0000 00 00800000 00 (EF0001 010004 02000100ED ff0000 00 00800000 "
                + "5d".repeat(237)
                + ")",
          ...
          {
            "EF00 01 010004 0200010001 0300010015 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00ff)",
            "dangling data in subcontainer",
            "invalid_section_bodies_size subcontainer size mismatch",
            1
          },
          {
            "EF00 01 010004 0200010001 0300010014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00ff)",
