...
public class EOFLayoutTest {
  ...
  public static Collection<Object[]> containersWithFormatErrors() {
    return Arrays.asList(
        new Object[][] {
          ...
          {"EF0001 010004 0200010001 ff", "No data section size", "incomplete_data_header", 1},
          {"EF0001 010004 0200010001 ff00", "Short data section size", "incomplete_data_header", 1},
          {
            "EF0001 010004 0200010001 ff0000",
            "No Terminator",
            "missing_headers_terminator Improper section headers",
            1
          },
          {
            "EF0001 010004 0200010002 ff0000 00",
            "No type section",
            "invalid_section_bodies_size Incomplete type section",
            1
          },
          {
            "EF0001 010004 0200010002 ff0001 ff0001 00 DA DA",
            "Duplicate data sections",
            "unexpected_header_kind expected 0 actual 255",
            1
          },
          {
            "EF0001 010004 0200010002 ff0000 00 00",
            "Incomplete type section",
            "invalid_section_bodies_size Incomplete type section",
            1
          },
          {
            "EF0001 010008 02000200020002 ff0000 00 00000000FE",
            "Incomplete type section",
            "invalid_section_bodies_size Incomplete type section",
            1
          },
          {
            "EF0001 010008 0200010001 ff0000 00 00000000 FE ",
            "Incorrect type section size",
            "invalid_section_bodies_size Type section - 0x1 * 4 != 0x8",
            1
          },
          {
            "EF0001 010008 02000200010001 ff0000 00 0100000000000000 FE FE",
            "Incorrect section zero type input",
            "invalid_first_section_type must be zero input non-returning",
            1
          },
          {
            "EF0001 010008 02000200010001 ff0000 00 0001000000000000 FE FE",
            "Incorrect section zero type output",
            "invalid_first_section_type must be zero input non-returning",
            1
          },
          {
            "EF0001 010004 0200010002 ff0000 00 00000000 ",
            "Incomplete code section",
            "invalid_section_bodies_size code section 0",
            1
          },
          {
            "EF0001 010004 0200010002 ff0000 00 00000000 FE",
            "Incomplete code section",
            "invalid_section_bodies_size code section 0",
            1
          },
          {
            "EF0001 010008 02000200020002 ff0000 00 00800000 00000000 FEFE ",
            "No code section multiple",
            "invalid_section_bodies_size code section 1",
            1
          },
          {
            "EF0001 010008 02000200020002 ff0000 00 00800000 00000000 FEFE FE",
            "Incomplete code section multiple",
            "invalid_section_bodies_size code section 1",
            1
          },
          {
            "EF0001 010004 0200010001 ff0003 00 00800000 FE DEADBEEF",
            "Excess data section",
            "invalid_section_bodies_size data after end of all sections",
            1
          },
          {
            "EF0001 0200010001 ff0001 00 FE DA",
            "type section missing",
            "unexpected_header_kind expected 1 actual 2",
            1
          },
          {
            "EF0001 010004 ff0001 00 00000000 DA",
            "code section missing",
            "unexpected_header_kind expected 2 actual 255",
            1
          },
          {
            "EF0001 010004 0200010001 00 00000000 FE",
            "data section missing",
            "unexpected_header_kind expected 255 actual 0",
            1
          },
          {
            "EF0001 ff0001 00 DA",
            "type and code section missing",
            "unexpected_header_kind expected 1 actual 255",
            1
          },
          {
  ...
  public static Collection<Object[]> correctContainers() {
    return Arrays.asList(
        new Object[][] {
          {
            "0xef0001 010004 0200010010 ff0000 00 00800002 e00001 f3 6001 6000 53 6001 6000 e0fff3 ",
            "1",
            null,
            1
          },
          {
            "EF0001 010010 0200040001000200020002 ff0000 00 00800000 01000001 00010001 02030003 FE 5000 3000 8000",
  ...
  public static Collection<Object[]> typeSectionTests() {
    return Arrays.asList(
        new Object[][] {
          {
            "EF0001 010008 02000200020002 ff0000 00 0100000000000000",
            "Incorrect section zero type input",
            "invalid_first_section_type must be zero input non-returning",
            1
          },
          {
            "EF0001 010008 02000200020002 ff0000 00 0001000000000000",
            "Incorrect section zero type output",
            "invalid_first_section_type must be zero input non-returning",
            1
          },
          {
            "EF0001 010010 0200040001000200020002 ff0000 00 00800000 F0000000 00010000 02030000 FE 5000 3000 8000",
            "inputs too large",
            "inputs_outputs_num_above_limit Type data input stack too large - 0xf0",
            1
          },
          {
            "EF0001 010010 0200040001000200020002 ff0000 00 00800000 01000000 00F00000 02030000 FE 5000 3000 8000",
            "outputs too large",
            "inputs_outputs_num_above_limit - 0xf0",
            1
          },
          {
            "EF0001 010010 0200040001000200020002 ff0000 00 00000400 01000000 00010000 02030400 FE 5000 3000 8000",
            "stack too large",
  ...
  public static Collection<Object[]> subContainers() {
    return Arrays.asList(
        new Object[][] {
          {
            "EF0001 010004 0200010001 03000100000014 ff0000 00 00800000 FE EF00010100040200010001ff00000000800000FE",
            "no data section, one code section, one subcontainer",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 03000100000014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)",
            "evmone - one container",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 03000100000014 ff0003 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00) 000000",
            "evmone - one container two bytes",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 030003000000140000001400000014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)",
            "evmone - three subContainers",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 030003000000140000001400000014 ff0003 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00) ddeeff",
            "evmone - three subContainers and data",
            null,
            1
          },
          {
            "EF00 01 01000C 020003000100010001 030003000000140000001400000014 ff0003 00 008000000000000000000000 00 00 00 (EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00)(EF0001 010004 0200010001 ff0000 00 00800000 00) ddeeff",
            "evmone - three subContainers three code and data",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 03000100000100 ff0000 00 00800000 00 (EF0001 010004 02000100ED ff0000 00 00800000 "
                + "5d".repeat(237)
                + ")",
          ...
          },
          {
            "EF00 01 010004 0200010001 030100"
                + "00000014".repeat(256)
                + "ff0000 00 00800000 00 "
                + "(EF0001 010004 0200010001 ff0000 00 00800000 00)".repeat(256),
            "evmone - 256 subContainers",
            null,
            1
          },
          {
            "EF00 01 010004 0200010001 03000100000015 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00ff)",
            "dangling data in subcontainer",
            "invalid_section_bodies_size subcontainer size mismatch",
            1
          },
          {
            "EF00 01 010004 0200010001 03000100000014 ff0000 00 00800000 00 (EF0001 010004 0200010001 ff0000 00 00800000 00ff)",
