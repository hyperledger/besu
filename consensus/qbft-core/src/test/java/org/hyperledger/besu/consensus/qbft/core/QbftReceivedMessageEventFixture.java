...
public class QbftReceivedMessageEventFixture implements QbftReceivedMessageEvent {

  private final QbftMessage message;

  public QbftReceivedMessageEventFixture(final QbftMessage message) {
