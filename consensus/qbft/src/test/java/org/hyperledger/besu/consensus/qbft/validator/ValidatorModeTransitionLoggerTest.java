...
public class ValidatorModeTransitionLoggerTest {
  ...
  public void doNotLogMessageWhenTransitioningFromBlockHeaderToBlockHeader() {
    ...
    when(forksSchedule.getFork(0, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(forkSpecA);
    when(forksSchedule.getFork(1, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(forkSpecB);
  ...
  public void doNotLogMessageWhenTransitioningFromContractToContractWithSameAddress() {
    ...
    when(forksSchedule.getFork(0, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(contractForkSpecA);
    when(forksSchedule.getFork(1, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(contractForkSpecB);
  ...
  public void logMessageWhenTransitioningFromContractToBlockHeader() {
    ...
    when(forksSchedule.getFork(0, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(contractForkSpec);
    when(forksSchedule.getFork(1, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(blockForkSpec);
  ...
  public void logMessageWhenTransitioningFromBlockHeaderToContract() {
    ...
    when(forksSchedule.getFork(0, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(blockForkSpec);
    when(forksSchedule.getFork(1, 0, ScheduledProtocolSpec.ScheduleType.BLOCK)).thenReturn(contractForkSpec);
