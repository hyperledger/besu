...
public class MergeProtocolScheduleTest {
  ...
  public void protocolSpecsAreCreatedAtBlockDefinedInJson() {
    ...
    final GenesisConfigOptions config = GenesisFile.fromConfig(jsonInput).getConfigOptions();
  ...
  public void mergeSpecificModificationsAreUnappliedForShanghai() {
    ...
    final GenesisConfigOptions config = GenesisFile.mainnet().getConfigOptions();
    final ProtocolSchedule protocolSchedule =
        MergeProtocolSchedule.create(
            config,
            false,
