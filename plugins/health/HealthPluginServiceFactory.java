...
public class HealthPluginServiceFactory implements PluginServiceFactory {
    ...
    public void appendPluginServices(final BesuPluginContextImpl besuContext) {
        ...
        if (p2pService != null && besuEvents != null) {
            besuContext.addService(LivenessCheckPluginService.class, new LivenessCheckPluginService());
            besuContext.addService(ReadinessCheckPluginService.class, new ReadinessCheckPluginService(p2pService, besuEvents));
        }
    }
}
