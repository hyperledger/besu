 ...
 * 
 * <p>Allows fine-grained configuration of individual columns when using separate database per column mode.
 */
public class PerColumnConfiguration {
   ...
   * @return this builder
   */
  public PerColumnConfiguration setColumnConfig(final String segmentName, final ColumnConfig config) {
  ...
  public static class OptimizedConfigs {
     ...
     * 
     * <p>Optimized for high write throughput with:
     ...
     * 
     * <p>Optimized for low latency reads with:
     * - Larger block cache
     * - Row cache for frequently accessed rows
     * - More open files for better caching
     * - Smaller write buffers (less memory)
     */
