...
public class BftService {
  private BftQueryService bftService;
   ...
   */
  public void setBftService(final BftQueryService bftService) {
   ...
   * Placeholder
   *
   * @return the BFT plugin service
   */
  public BftQueryService getBftService() {
    return this.bftService;
  }
}
