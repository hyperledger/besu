...
- Prevent Besu from starting up if sync-mode=FULL and bonsai-limit-trie-logs-enabled=true for all configurations [#7354](https://github.com/hyperledger/besu/pull/7354)
