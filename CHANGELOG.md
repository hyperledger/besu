...
- Fix to gas limit delta calculations used in block production. Besu should now incrment or decerement the block gas limit towards its target correctly now (thanks @arbora) #6425
