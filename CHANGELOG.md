...
- Improve the sync perfomance by not RLP decoding bodies during sync. This means we are using less memory and CPU, allowing us to increase the prallelism of the download pripeline. [#8959]
