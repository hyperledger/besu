...
- JSON output is now compact by default. This can be overridden by the new `--pretty-json-enabled` CLI option. [#5766](https://github.com/hyperledger/besu/pull/5766)
