...
### Deprecations
- `--tx-pool-disable-locals` has been deprecated for removal in favor of `--tx-pool-no-local-priority`, not semantic change, only a renaming [#5959](https://github.com/hyperledger/besu/pull/5959)
