...
public class SignatureAlgorithmTypeTest {
  ...
  public void shouldReturnSECP256K1InstanceWithEmptyOptional() {
    SignatureAlgorithmType signatureAlgorithmType = SignatureAlgorithmType.create(Optional.empty());
  ...
  public void shouldReturnSECP256K1Instance() {
    SignatureAlgorithmType signatureAlgorithmType =
        SignatureAlgorithmType.create(Optional.of("secp256k1"));
  ...
  public void shouldThrowExceptionWhenInvalidParameterIsGiven() {
    assertThatThrownBy(() -> SignatureAlgorithmType.create(Optional.of("abcd")))
        .hasMessage(
