...
public class Ed25519 {
    final private static String ADDRESS_LABEL = "address";
    final private static int PUBLIC_KEY_ID = -2;
    ...
    public static boolean verify(final byte[] rawCOSESign1, final byte[] rawCOSEKey) {
        ...
        byte[] rawAddress = sign1.headers()._protected().getAsHeaderMap().otherHeaderAsBytes(ADDRESS_LABEL);
        ...
        boolean signatureVerification = signer.verify(
                sign1.signature(),
