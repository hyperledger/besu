...
public class Node {
    ...
    public void initNode(final Node[] listOfNodes, final CrosschainCoordinationContract ccc, final ThresholdKeyGenContract thesholdContract) throws Exception {
...
//        this.nodeId = BigInteger.valueOf(this.nodeNumber +1);
    ...
    private Object sendPrivateMessage(final InterNodeMessages type, final Node destination) throws Exception {
        return sendPrivateMessage(type, destination, null);
    }
    private Object sendPrivateMessage(final InterNodeMessages type, final Node destination, final Object data) throws Exception {
        switch (type) {
    ...
    private Object receiveMessage(final InterNodeMessages type, final Object anything1, final Object anything2) throws Exception {
        switch (type) {
            case REQUEST_SEND_SECRET_SHARES:
                doKeyGenerationSingleNode();
                return null;
