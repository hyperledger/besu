...
public final class ThresholdScheme {
     ...
     */
    public ThresholdScheme(final BlsCryptoProvider cryptoProvider, final int threshold, final SecureRandom rand) {
     ...
     */
    public IntegerSecretShare[] generateSecretShares(final BigInteger secret, final BigInteger[] xValues, final BigInteger[] coefficients) {
    ...
    public IntegerSecretShare[] generateSecretShares(final BigInteger[] xValues, final BigInteger[] coefficients) {
     ...
     */
    public BigInteger[] generateShares(final BigInteger secret, final BigInteger[] xValues, final BigInteger[] coefficients) {
