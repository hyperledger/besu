 ...
 */
public class SECP256K1 extends AbstractSignatureAlgorithm {
  ...
  public SECPSignature sign(final Bytes dataHash, final KeyPair keyPair) {
    if (useNative) {
      ...
      return super.sign(dataHash, keyPair, new SHA256Digest());
    }
  }
  ...
  public SECPSignature normaliseSignature(
    ...
    return super.normaliseSignature(nativeR, nativeS, publicKey, dataHash, SecP256K1Curve.q);
  }
  ...
  public Optional<SECPPublicKey> recoverPublicKeyFromSignature(
    ...
    if (useNative) {
      ...
      return super.recoverPublicKeyFromSignature(dataHash, signature, SecP256K1Curve.q);
    }
  }
