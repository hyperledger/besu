...
public abstract class AbstractSegmentedKeyValueStorageTest extends AbstractKeyValueStorageTest {
  ...
  protected SegmentedKeyValueStorage createSegmentedKeyValueStorageWithValues() throws IOException {
      ...
      IntStream.range(1, 10)
          .forEach(
              i -> {
                ...
                System.out.println(Bytes.of(key));
                ...
                System.out.println(Bytes.of(key2));
