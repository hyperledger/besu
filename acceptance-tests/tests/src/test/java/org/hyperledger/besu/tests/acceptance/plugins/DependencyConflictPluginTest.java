...
public class DependencyConflictPluginTest extends AcceptanceTestBase {
  ...
  public void warnOnOutdatedPluginByDefault() throws IOException {
    ...
    assertTrue(
        cluster
            ...
            .filter(line -> line.contains("dependencyConflict1.jar"))
            .filter(line -> line.contains("dependencyConflict2.jar"))
            .anyMatch(
                line ->
                    line.contains(
