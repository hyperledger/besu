...
public class JsonRpcWebsocketAuthenticationRsaAcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws IOException, URISyntaxException {
    ...
    nodeUsingAuthFile = besu.createNodeWithAuthentication("nodeAuthFile", AUTH_FILE);
    nodeUsingRsaJwtPublicKey = besu.createNodeWithAuthenticationUsingRsaJwtPublicKey("nodeRsa");
    authenticatedCluster.start(nodeUsingAuthFile, nodeUsingRsaJwtPublicKey);
