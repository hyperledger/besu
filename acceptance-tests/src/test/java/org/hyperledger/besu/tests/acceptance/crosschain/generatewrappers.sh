...
# Testing viewcall
solc viewcall/FooCtrt.sol --allow-paths . --bin --abi --overwrite --optimize -o build
solc viewcall/FooInt.sol --allow-paths . --bin --abi --overwrite --optimize -o build
solc viewcall/BarCtrt.sol --allow-paths . --bin --abi --overwrite --optimize -o build
$WEB3J solidity generate -cc -a=build/FooCtrt.abi -b=build/FooCtrt.bin -o=../../../../../../ -p=org.hyperledger.besu.tests.acceptance.crosschain.viewcall.generated
$WEB3J solidity generate -cc -a=build/BarCtrt.abi -b=build/BarCtrt.bin -o=../../../../../../ -p=org.hyperledger.besu.tests.acceptance.crosschain.viewcall.generated
$WEB3J solidity generate -cc -a=build/FooInt.abi -b=build/FooInt.bin -o=../../../../../../ -p=org.hyperledger.besu.tests.acceptance.crosschain.viewcall.generated
