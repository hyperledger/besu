...
public class BesuNodeFactory {
  ...
  public BesuNode createCrosschainCoordinationBlockchainIbft2Node(final String name)
      throws IOException {
    return create(
        new BesuNodeConfigurationBuilder()
            .name(name)
            ...
            .webSocketConfiguration(node.createWebSocketEnabledConfig())
            .devMode(false)
            .genesisConfigProvider(genesis::createCrosschainCoordinationBlockchainGenesisConfig)
            .build());
  }
  ...
  public BesuNode createCrosschainBlockchain1Ibft2Node(final String name) throws IOException {
    return create(
        new BesuNodeConfigurationBuilder()
            ...
            .webSocketConfiguration(node.createWebSocketEnabledConfig())
            .devMode(false)
            .genesisConfigProvider(genesis::createCrosschainBlockchain1GenesisConfig)
            .build());
  }
  ...
  public BesuNode createCrosschainBlockchain2Ibft2Node(final String name) throws IOException {
    return create(
        new BesuNodeConfigurationBuilder()
            ...
            .webSocketConfiguration(node.createWebSocketEnabledConfig())
            .devMode(false)
            .genesisConfigProvider(genesis::createCrosschainBlockchain2GenesisConfig)
            .build());
  }
