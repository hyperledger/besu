...
import org.hyperledger.besu.tests.acceptance.dsl.transaction.privacy.PrivDistributeRawTransaction;

public class PrivDistributeRawTransactionSuccess implements Condition {

  private final PrivDistributeRawTransaction sendRawTransactionTransaction;
  private final String enclaveResponseKey;

  public PrivDistributeRawTransactionSuccess(
      final PrivDistributeRawTransaction sendRawTransactionTransaction,
