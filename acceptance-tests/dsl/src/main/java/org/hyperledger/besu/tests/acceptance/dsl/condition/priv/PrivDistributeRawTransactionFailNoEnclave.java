...
public class PrivDistributeRawTransactionFailNoEnclave implements Condition {

  private final PrivDistributeRawTransactionTransaction sendRawTransactionTransaction;

  public PrivDistributeRawTransactionFailNoEnclave(
  ...
  public void verify(final Node node) {
    try {
      ...
      assertThat(e)
          ...
          .hasMessageContaining(ENCLAVE_ERROR.getMessage());
    }
  }
}
