...
public class PrivDistributeRawTransactionFailInvalidTransaction implements Condition {

  private final PrivDistributeRawTransactionTransaction sendRawTransactionTransaction;

  public PrivDistributeRawTransactionFailInvalidTransaction(
  ...
  public void verify(final Node node) {
    try {
      ...
      assertThat(e)
          ...
          .hasMessageContaining(DECODE_ERROR.getMessage());
    }
  }
}
