...
public class EeaSendRawTransactionFailPrivateFromNotMatchEnclaveKey implements Condition {

  private final EeaSendRawTransactionTransaction sendRawTransactionTransaction;

  public EeaSendRawTransactionFailPrivateFromNotMatchEnclaveKey(
  ...
  public void verify(final Node node) {
    try {
      node.execute(sendRawTransactionTransaction);
