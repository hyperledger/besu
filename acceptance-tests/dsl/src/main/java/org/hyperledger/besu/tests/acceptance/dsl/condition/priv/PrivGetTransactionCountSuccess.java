...
public class PrivGetTransactionCountSuccess implements Condition {
  ...
  private final PrivGetTransactionCountTransaction transaction;

  public PrivGetTransactionCountSuccess(final PrivGetTransactionCountTransaction transaction) {
    this.transaction = transaction;
  }

  @Override
  public void verify(final Node node) {
    Integer result = node.execute(transaction);
    // TODO: Better assertion required.
