...
public class PrivDeletePrivacyGroupFailEnclaveKeyNotInGroup implements Condition {

  private final PrivDeletePrivacyGroupTransaction transaction;

  public PrivDeletePrivacyGroupFailEnclaveKeyNotInGroup(
      final PrivDeletePrivacyGroupTransaction transaction) {
  ...
  public void verify(final Node node) {
    try {
      ...
      assertThat(e)
          ...
          .hasMessageContaining(DELETE_PRIVACY_GROUP_ERROR.getMessage());
    }
  }
}
