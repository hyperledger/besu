...
public class PrivGetTransactionReceiptNoResult implements Condition {

  private final PrivGetTransactionReceiptTransaction getTransactionReceiptTransaction;

  public PrivGetTransactionReceiptNoResult(
  ...
  public void verify(final Node node) {
    try {
      WaitUtils.waitFor(
          () -> assertThat(node.execute(getTransactionReceiptTransaction)).isNotNull());
      fail("Expected result to remain null.");
