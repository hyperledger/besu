...
public class PrivFindPrivacyGroupFailEnclaveKeyNotInGroup implements Condition {

  private final PrivFindPrivacyGroupTransaction transaction;

  public PrivFindPrivacyGroupFailEnclaveKeyNotInGroup(
      final PrivFindPrivacyGroupTransaction transaction) {
