...
public enum LoggingFormat {
  ...
  /** Splunk HEC (HTTP Event Collector) logging. */
  SPLUNK(null);
   ...
   *
   * @return the event template URI, or null for PLAIN and SPLUNK formats
   */
  ...
  /**
   * Whether this format uses structured JSON output via JsonTemplateLayout.
   *
   * @return true if this is a JSON-based format
   */
  public boolean isJsonFormat() {
    return this != PLAIN && this != SPLUNK;
  }

  /**
   * Whether this format uses the Splunk HEC appender.
   *
   * @return true if this is the Splunk format
   */
  public boolean isSplunkFormat() {
    return this == SPLUNK;
  }
}
