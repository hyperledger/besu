...
public class EthstatsOptions implements CLIOptions<EthStatsConnectOptions> {
  ...
  @CommandLine.Option(
    ...
    arity = "1")
  private int ethstatsReportInterval = 5;
  ...
  public EthStatsConnectOptions toDomainObject() {
    return EthStatsConnectOptions.fromParams(ethstatsUrl, ethstatsContact, ethstatsCaCert, ethstatsReportInterval);
  }
   ...
   */
  public int getEthstatsReportInterval() {
