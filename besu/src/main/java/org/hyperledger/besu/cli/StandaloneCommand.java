...
class StandaloneCommand implements DefaultCommandValues {
  ...
  @CommandLine.Option(
      ...
      paramLabel = MANDATORY_FILE_FORMAT_HELP,
      description = "External JSON-RPC HTTP authentication public key used for validating JWT",
      arity = "1")
  ...
  @CommandLine.Option(
      ...
      paramLabel = MANDATORY_FILE_FORMAT_HELP,
      description = "External JSON-RPC WebSocket authentication public key used for validating JWT",
      arity = "1")
