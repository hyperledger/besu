...
class DurationConversionException : Exception {
    /**
     * Instantiates a new Duration conversion exception for malformed value.
     *
     * @param value the value
     */
    constructor(value: String?) : super(String.format("'%s' is not a long", value))
     ...
     */
    constructor(value: Long) : super(String.format("negative value '%d' is not allowed", value))
}
