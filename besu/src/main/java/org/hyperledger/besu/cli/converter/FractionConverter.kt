...
/** Default constructor.  */
    : CommandLine.ITypeConverter<Fraction> {
    @Throws(FractionConversionException::class)
    override fun convert(value: String): Fraction {
        try {
            return Fraction.fromString(value)
        } catch (e: NullPointerException) {
            throw FractionConversionException(value)
