...
abstract class MapperAdapter {
  ...
  abstract <T> T map(TypeReference<T> clazz) throws Exception;

  static MapperAdapter getMapper(final String initFile){
  ...
  String writeValueAsString(InitConfiguration initConfig) throws JsonProcessingException {
