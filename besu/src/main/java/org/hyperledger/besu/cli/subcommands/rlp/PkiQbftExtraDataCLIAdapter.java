...
/** Adapter to convert a typed JSON of addresses to a PKI QBFT RLP extra data encoding */
public class PkiQbftExtraDataCLIAdapter implements JSONToRLP {
  ...
  private Bytes fromJsonAddresses(final String jsonAddresses) throws IOException {
    ...
    return PkiQbftExtraDataCodec.encodeFromAddresses(
