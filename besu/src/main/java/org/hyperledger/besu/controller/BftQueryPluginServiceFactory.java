...
import org.hyperledger.besu.consensus.ibft.queries.BftQueryServiceImpl;
...
public class BftQueryPluginServiceFactory implements PluginServiceFactory {
  ...
  public BftQueryPluginServiceFactory(final Blockchain blockchain, final NodeKey nodeKey) {
  ...
  public void appendPluginServices(final BesuPluginContextImpl besuContext) {
    ...
    final BftQueryServiceImpl service =
        new BftQueryServiceImpl(blockInterface, blockchain, nodeKey);
