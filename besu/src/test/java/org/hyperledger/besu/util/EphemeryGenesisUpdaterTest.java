...
public class EphemeryGenesisUpdaterTest {
  ...
  private static final GenesisFile INVALID_GENESIS_JSON = fromConfig("{}");
  ...
  public void testEphemeryWhenChainIdIsAbsent() {
    final GenesisFile config =
        GenesisFile.fromConfig(INVALID_GENESIS_JSON_WITHOUT_CHAINID.toString());
  ...
  public void testShouldDefaultTimestampToZero() {
    final GenesisFile config =
        GenesisFile.fromConfig(INVALID_GENESIS_JSON_WITHOUT_TIMESTAMP.toString());
  ...
  public void testEphemeryWhenGenesisJsonIsValid() {
    final GenesisFile config = GenesisFile.fromConfig(VALID_GENESIS_JSON.toString());
  ...
  void testOverrideWithUpdatedChainIdAndTimeStamp() {
    ...
    final GenesisFile config = GenesisFile.fromResource("/ephemery.json");
  ...
  public void testEphemeryWhenSuccessful() {
    ...
    override.put("chainId", String.valueOf(expectedChainId));
    override.put("timestamp", String.valueOf(expectedGenesisTimestamp));
    final GenesisFile updatedConfig = config.withOverrides(override);
