...
public class TransitionControllerBuilderTest {
  ...
  public void setup() {
    ...
    cliqueBuilder.genesisConfig(GenesisFile.DEFAULT);
    powBuilder.genesisConfig(GenesisFile.DEFAULT);
    postMergeBuilder.genesisConfig(GenesisFile.DEFAULT);
  ...
  TransitionCoordinator buildTransitionCoordinator(
    ...
    builder.genesisConfig(GenesisFile.mainnet());
