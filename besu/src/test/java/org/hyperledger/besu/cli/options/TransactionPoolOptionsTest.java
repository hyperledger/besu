...
public class TransactionPoolOptionsTest
  ...
  public void maxPrioritizedTxsPerTypeWrongTxType() {
    internalTestFailure(
        "Invalid value for option '--tx-pool-max-prioritized-by-type' (MAP<TYPE,INTEGER>): expected one of [FRONTIER, ACCESS_LIST, EIP1559, BLOB, DELEGATE_CODE, INITCODE] (case-insensitive) but was 'WRONG_TYPE'",
        "--tx-pool-max-prioritized-by-type",
        "WRONG_TYPE=1");
  }
