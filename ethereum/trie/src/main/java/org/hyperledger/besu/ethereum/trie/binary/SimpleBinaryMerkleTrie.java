 ...
 */
public class SimpleBinaryMerkleTrie<K extends Bytes, V> extends SimpleMerkleTrie<K,V> implements MerkleTrie<K, V> {
  private final GetVisitor<V> getVisitor = new GetVisitor<>();


  public SimpleBinaryMerkleTrie(final Function<V, Bytes> valueSerializer) {
