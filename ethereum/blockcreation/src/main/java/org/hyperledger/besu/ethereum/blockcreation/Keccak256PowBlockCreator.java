...
public class Keccak256PowBlockCreator extends AbstractBlockCreator<Void> {
  ...
  protected BlockHeader createFinalBlockHeader(final SealableBlockHeader sealableBlockHeader) {
    ...
    try {
      solution =
          nonceSolver.solveFor(
              Keccak256PowSolver.Keccak256PowSolverJob.createFromInputs(workDefinition));
    ...
    return BlockHeaderBuilder.create()
        .populateFrom(sealableBlockHeader)
               .mixHash(Hash.fromHexString(
                "0xc5e3c33c86d64d0641dd3c86e8ce4628fe0aac0ef7b4c087c5fcaa45d5046d90")) //inject fake mixHash
