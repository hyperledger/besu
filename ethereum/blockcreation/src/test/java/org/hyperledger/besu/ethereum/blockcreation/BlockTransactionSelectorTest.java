...
public class BlockTransactionSelectorTest {
  ...
  public void failedTransactionsAreIncludedInTheBlock() {
    ...
    when(transactionProcessor.processTransaction(
        ...
        .thenReturn(
            MainnetTransactionProcessor.ProcessingResult.failed(
  ...
  public void invalidTransactionsTransactionProcessingAreSkippedButBlockStillFills() {
    ...
    when(transactionProcessor.processTransaction(
        ...
        .thenReturn(
            MainnetTransactionProcessor.ProcessingResult.successful(
    ...
    when(transactionProcessor.processTransaction(
            ...
            any()))
        .thenReturn(
            MainnetTransactionProcessor.ProcessingResult.invalid(
