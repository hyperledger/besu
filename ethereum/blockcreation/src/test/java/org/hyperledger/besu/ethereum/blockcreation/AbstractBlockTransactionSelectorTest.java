...
public abstract class AbstractBlockTransactionSelectorTest {
  ...
  public void setup() {
    ...
    final Block genesisBlock = GenesisState.fromConfig(genesisFile, protocolSchedule).getBlock();
  ...
  protected abstract GenesisFile getGenesisConfig();
