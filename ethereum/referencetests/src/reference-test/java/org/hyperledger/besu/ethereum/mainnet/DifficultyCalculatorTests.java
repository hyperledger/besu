    ...
    return Stream.of(
        Arguments.of(
            ...
            MainnetProtocolSchedule.fromConfig(
                ...
                EvmConfiguration.DEFAULT, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())),
        Arguments.of(
          "/DifficultyTests/dfGrayGlacier/difficultyGrayGlacierForkBlock.json",
          MainnetProtocolSchedule.fromConfig(
              new StubGenesisConfigOptions().grayGlacierBlock(15050000), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(
              new StubGenesisConfigOptions().arrowGlacierBlock(13773000), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().byzantiumBlock(0), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
          "/DifficultyTests/dfConstantinople/difficultyConstantinople.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().constantinopleBlock(0), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
          "/DifficultyTests/dfEIP2384/difficultyEIP2384.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().muirGlacierBlock(0), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions(), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ),
        Arguments.of(
          "/DifficultyTests/dfHomestead/difficultyHomestead.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().homesteadBlock(0), DataStorageConfiguration.DEFAULT_CONFIG, MiningConfiguration.MINING_DISABLED, new BadBlockManager(), BalConfiguration.DEFAULT, new NoOpMetricsSystem())
        ));
  }
