    ...
    return Stream.of(
        Arguments.of(
            ...
            MainnetProtocolSchedule.fromConfig(
                ...
                EvmConfiguration.DEFAULT, MiningParameters.newDefault(), new BadBlockManager(), false)),
        Arguments.of(
          "/DifficultyTests/dfGrayGlacier/difficultyGrayGlacierForkBlock.json",
          MainnetProtocolSchedule.fromConfig(
              new StubGenesisConfigOptions().grayGlacierBlock(15050000), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(
              new StubGenesisConfigOptions().arrowGlacierBlock(13773000), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().byzantiumBlock(0), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
          "/DifficultyTests/dfConstantinople/difficultyConstantinople.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().constantinopleBlock(0), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
          "/DifficultyTests/dfEIP2384/difficultyEIP2384.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().muirGlacierBlock(0), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
        ...
        Arguments.of(
          ...
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions(), MiningParameters.newDefault(), new BadBlockManager(), false)
        ),
        Arguments.of(
          "/DifficultyTests/dfHomestead/difficultyHomestead.json",
          MainnetProtocolSchedule.fromConfig(new StubGenesisConfigOptions().homesteadBlock(0), MiningParameters.newDefault(), new BadBlockManager(), false)
        ));
  }
