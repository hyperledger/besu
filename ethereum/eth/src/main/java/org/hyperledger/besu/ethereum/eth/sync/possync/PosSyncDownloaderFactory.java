...
public class PosSyncDownloaderFactory extends SnapDownloaderFactory {

  private static final Logger LOG = LoggerFactory.getLogger(PosSyncDownloaderFactory.class);
