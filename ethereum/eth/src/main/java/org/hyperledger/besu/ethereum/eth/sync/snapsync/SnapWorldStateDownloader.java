...
public class SnapWorldStateDownloader implements WorldStateDownloader {
  ...
  private final CachingTaskCollection<SnapDataRequest> taskCollection;
  ...
  public CompletableFuture<Void> run(
    ...
    synchronized (this) {
      ...
      if (!newDownloadState.downloadWasResumed()) {
        RangeManager.generateAllRanges(128)
            .forEach(
                (key, value) ->
      ...
      downloadProcess =
          SnapWorldStateDownloadProcess.builder()
              ...
              .persistDataStep(new PersistDataStep(newDownloadState, worldStateStorage))
