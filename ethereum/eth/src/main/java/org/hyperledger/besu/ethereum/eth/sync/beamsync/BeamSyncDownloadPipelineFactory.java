...
import org.hyperledger.besu.ethereum.eth.sync.fastsync.FastImportBlocksStep;
...
public class BeamSyncDownloadPipelineFactory<C> implements DownloadPipelineFactory {
  ...
  public BeamSyncDownloadPipelineFactory(
    ...
    this.pivotBlockHeader = launchBlockHeader;
  ...
  public Pipeline<?> createDownloadPipelineForSyncTarget(final SyncTarget target) {
    ...
    // TODO - Evaluate CheckpointRangeSource Params as they relate to Beam Sync.
