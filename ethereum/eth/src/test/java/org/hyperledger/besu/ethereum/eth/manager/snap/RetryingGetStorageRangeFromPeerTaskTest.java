...
public class RetryingGetStorageRangeFromPeerTaskTest
    extends AbstractMessageTaskTestBase<
        StorageRangeMessage.SlotRangeData, RetryingGetStorageRangeFromPeerTask> {

  private EthTask<StorageRangeMessage.SlotRangeData> createTask() {
  ...
  public void checkEmptyResponseReducesReputation() {
    ...
    final EthTask<StorageRangeMessage.SlotRangeData> task = createTask();
    final CompletableFuture<StorageRangeMessage.SlotRangeData> future = task.run();
