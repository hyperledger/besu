...
public class LayeredPendingTransactionsTest extends BaseTransactionPoolTest {
  ...
  //      final var tx = createTransaction(i, Wei.of(10L),
  ...
  //    assertThat(metricsSystem.getCounterValue(PRIORITIZED_COUNTER, REMOTE,
  // REPLACED)).isEqualTo(1);
  //  }
  //
  //  @Test
  ...
  //        .isEqualTo(ADDED);
  //    assertThat(
  //            pendingTransactions.addRemoteTransaction(duplicateTx,
  ...
  //    assertThat(
  //            pendingTransactions.addLocalTransaction(replacingTx,
  // Optional.empty()).isReplacement())
  //        .isTrue();
  //    assertThat(pendingTransactions.addRemoteTransaction(independentTx, Optional.empty()))
  //        .isEqualTo(ADDED);
  ...
  //    pendingTransactions.addRemoteTransaction(createTransaction(0, KEYS1),
  // Optional.of(firstSender));
  //    assertNextNonceForSender(pendingTransactions, SENDER1, 1);
  //
  //    pendingTransactions.addRemoteTransaction(createTransaction(1, KEYS1),
  // Optional.of(firstSender));
  //    assertNextNonceForSender(pendingTransactions, SENDER1, 2);
  //
  //    pendingTransactions.addRemoteTransaction(createTransaction(2, KEYS1),
  // Optional.of(firstSender));
  ...
  //        final var res = pendingTransactions.addRemoteTransaction(transaction,
  // Optional.of(sender));
  //        if (afterGap) {
