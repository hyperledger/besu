...
public class EthPeersTest {
  ...
  public void comparesPeersWithHeightAndTd() {
    ...
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerA, peerB)).isLessThan(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerB, peerA)).isGreaterThan(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerA, peerA)).isEqualTo(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerB, peerB)).isEqualTo(0);
  ...
  public void comparesPeersWithTdAndNoHeight() {
    ...
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerA, peerB)).isGreaterThan(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerB, peerA)).isLessThan(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerA, peerA)).isEqualTo(0);
    assertThat(EthPeers.TOTAL_DIFFICULT_THEN_HEIGHT.compare(peerB, peerB)).isEqualTo(0);
