...
public class SnapWorldDownloadStateTest {
  ...
  public void shouldRestartHealWhenNewPivotBlock() {
    ...
    // reload the heal
    when(snapSyncState.isHealInProgress()).thenReturn(true, false);
    downloadState.onNewPivotBlock();
  ...
  public void shouldStopWaitingBlockchainWhenNewPivotBlockAvailable() {
    ...
    when(snapSyncState.getPivotBlockHeader()).thenReturn(Optional.of(newPivotBlock));
    downloadState.onNewPivotBlock();
