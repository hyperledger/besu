...
public abstract class AbstractPrioritizedTransactionsTestBase {
  ...
  //    assertThat(transactions.addRemoteTransaction(transaction1,
  // Optional.empty())).isEqualTo(ADDED);
  //    assertThat(transactions.addRemoteTransaction(transaction2,
  // Optional.empty())).isEqualTo(ADDED);
  //    assertThat(transactions.addRemoteTransaction(transaction1b,
  // Optional.empty()).isReplacement())
  //        .isTrue();
  //
  ...
  //    assertThat(metricsSystem.getCounterValue(REPLACED_COUNTER, REMOTE,
  // PRIORITY_LIST)).isEqualTo(1);
  //  }
  //
  //  @Test
  ...
  //    assertThat(transactions.addRemoteTransaction(independentTx,
  // Optional.empty())).isEqualTo(ADDED);
  ...
  //
  //    assertThat(transactions.size()).isEqualTo(2);
  //    assertThat(metricsSystem.getCounterValue(ADDED_COUNTER, REMOTE)).isEqualTo(replacedTxCount +
  // 2);
  ...
  //    assertThat(transactions.addRemoteTransaction(transaction0,
  // Optional.empty())).isEqualTo(ADDED);
  //    assertThat(transactions.addRemoteTransaction(transaction0b,
  // Optional.empty()).isReplacement())
  //        .isTrue();
  //
