...
public class PeerTableTest {
  ...
  public void ipAddressIsInvalidReturnsTrue() {
    ...
    final DiscoveryPeer peer1 = DiscoveryPeer.fromIdAndEndpoint(Bytes.random(64), endpoint1);
    final DiscoveryPeer peer2 = DiscoveryPeer.fromIdAndEndpoint(Bytes.random(64), endpoint2);
