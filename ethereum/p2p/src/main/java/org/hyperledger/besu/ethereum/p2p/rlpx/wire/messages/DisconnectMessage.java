...
public final class DisconnectMessage extends AbstractMessageData {
  ...
  public enum DisconnectReason {
    ...
    USELESS_PEER_CANNOT_CONFIRM_PIVOT_BLOCK((byte) 0x03, "Cannot confirm pivot block"),
    ...
    USELESS_PEER_MAX_RETRIES_REACHED((byte) 0x03, "Max retries reached"),
    ...
    TIMEOUT((byte) 0x0b),
    TIMEOUT_CONFIRMING_PIVOT_BLOCK((byte) 0x0b, "Timeout confirming pivot block"),
