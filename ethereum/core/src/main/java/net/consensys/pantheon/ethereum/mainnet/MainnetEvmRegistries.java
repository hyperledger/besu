...
import net.consensys.pantheon.ethereum.vm.OperationRegistry;
import net.consensys.pantheon.ethereum.vm.operations.AddModOperation;
import net.consensys.pantheon.ethereum.vm.operations.AddOperation;
import net.consensys.pantheon.ethereum.vm.operations.AddressOperation;
import net.consensys.pantheon.ethereum.vm.operations.AndOperation;
...
import net.consensys.pantheon.ethereum.vm.operations.ByteOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallCodeOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallDataCopyOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallDataLoadOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallDataSizeOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallValueOperation;
import net.consensys.pantheon.ethereum.vm.operations.CallerOperation;
import net.consensys.pantheon.ethereum.vm.operations.CodeCopyOperation;
import net.consensys.pantheon.ethereum.vm.operations.CodeSizeOperation;
import net.consensys.pantheon.ethereum.vm.operations.CoinbaseOperation;
import net.consensys.pantheon.ethereum.vm.operations.Create2Operation;
import net.consensys.pantheon.ethereum.vm.operations.CreateOperation;
import net.consensys.pantheon.ethereum.vm.operations.DelegateCallOperation;
import net.consensys.pantheon.ethereum.vm.operations.DifficultyOperation;
import net.consensys.pantheon.ethereum.vm.operations.DivOperation;
import net.consensys.pantheon.ethereum.vm.operations.DupOperation;
...
import net.consensys.pantheon.ethereum.vm.operations.GasPriceOperation;
import net.consensys.pantheon.ethereum.vm.operations.GtOperation;
import net.consensys.pantheon.ethereum.vm.operations.InvalidOperation;
import net.consensys.pantheon.ethereum.vm.operations.IsZeroOperation;
import net.consensys.pantheon.ethereum.vm.operations.JumpDestOperation;
import net.consensys.pantheon.ethereum.vm.operations.JumpOperation;
import net.consensys.pantheon.ethereum.vm.operations.JumpiOperation;
import net.consensys.pantheon.ethereum.vm.operations.LogOperation;
import net.consensys.pantheon.ethereum.vm.operations.LtOperation;
import net.consensys.pantheon.ethereum.vm.operations.MLoadOperation;
import net.consensys.pantheon.ethereum.vm.operations.MSizeOperation;
...
import net.consensys.pantheon.ethereum.vm.operations.ModOperation;
import net.consensys.pantheon.ethereum.vm.operations.MulModOperation;
import net.consensys.pantheon.ethereum.vm.operations.MulOperation;
import net.consensys.pantheon.ethereum.vm.operations.NotOperation;
import net.consensys.pantheon.ethereum.vm.operations.NumberOperation;
import net.consensys.pantheon.ethereum.vm.operations.OrOperation;
import net.consensys.pantheon.ethereum.vm.operations.OriginOperation;
import net.consensys.pantheon.ethereum.vm.operations.PCOperation;
import net.consensys.pantheon.ethereum.vm.operations.PopOperation;
import net.consensys.pantheon.ethereum.vm.operations.PushOperation;
import net.consensys.pantheon.ethereum.vm.operations.ReturnDataCopyOperation;
import net.consensys.pantheon.ethereum.vm.operations.ReturnDataSizeOperation;
import net.consensys.pantheon.ethereum.vm.operations.ReturnOperation;
import net.consensys.pantheon.ethereum.vm.operations.RevertOperation;
import net.consensys.pantheon.ethereum.vm.operations.SDivOperation;
import net.consensys.pantheon.ethereum.vm.operations.SGtOperation;
import net.consensys.pantheon.ethereum.vm.operations.SLoadOperation;
import net.consensys.pantheon.ethereum.vm.operations.SLtOperation;
import net.consensys.pantheon.ethereum.vm.operations.SModOperation;
import net.consensys.pantheon.ethereum.vm.operations.SStoreOperation;
import net.consensys.pantheon.ethereum.vm.operations.SarOperation;
...
import net.consensys.pantheon.ethereum.vm.operations.ShlOperation;
import net.consensys.pantheon.ethereum.vm.operations.ShrOperation;
import net.consensys.pantheon.ethereum.vm.operations.SignExtendOperation;
import net.consensys.pantheon.ethereum.vm.operations.StaticCallOperation;
import net.consensys.pantheon.ethereum.vm.operations.StopOperation;
import net.consensys.pantheon.ethereum.vm.operations.SubOperation;
import net.consensys.pantheon.ethereum.vm.operations.SwapOperation;
import net.consensys.pantheon.ethereum.vm.operations.TimestampOperation;
import net.consensys.pantheon.ethereum.vm.operations.XorOperation;
