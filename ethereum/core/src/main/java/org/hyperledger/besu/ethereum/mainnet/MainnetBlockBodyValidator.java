...
public class MainnetBlockBodyValidator implements BlockBodyValidator {
  ...
  public boolean validateBodyLight(
    ...
    if (Boolean.FALSE.equals(BodyValidation.bodiesValidatedRootsCache.getIfPresent(header))) {
    ...
    if (Boolean.FALSE.equals(BodyValidation.receiptsRootCache.getIfPresent(header))) {
