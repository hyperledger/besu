...
public class BonsaiDbWorldStateWriteSink implements WorldStateWriteSink {

  private final BonsaiWorldStateKeyValueStorage.Updater updater;

  public BonsaiDbWorldStateWriteSink(final BonsaiWorldStateKeyValueStorage.Updater updater) {
