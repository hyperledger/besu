...
public class ProtocolSpec {
  ...
  private final Duration blockPeriodPoS;
   ...
   * @param blockPeriodPoS the block period when in PoS
  ...
  public ProtocolSpec(
    ...
    this.isPoS = isPoS;
    this.blockPeriodPoS = blockPeriodPoS;
  ...
  public Duration getBlockPeriodPos() {
    return blockPeriodPoS;
  }
