...
public class OptionalUnsignedLongDeserializer extends StdDeserializer<OptionalLong> {
  ...
  @Override
  public OptionalLong deserialize(final JsonParser jsonparser, final DeserializationContext context)
      throws IOException {
    final var uint64 =
    ...
    return OptionalLong.of(UInt64s.min(uint64, GAS_MAX_VALUE).toLong());
  }
}
