...
public class BonsaiCachedWorldStateStorage extends BonsaiWorldStateKeyValueStorage {
   ...
   */
  public BonsaiCachedWorldStateStorage createSnapshot() {
    final BonsaiSnapshotWorldStateKeyValueStorage snapshot = new BonsaiSnapshotWorldStateKeyValueStorage(
            parent);
    return new BonsaiCachedWorldStateStorage(
            snapshot.flatDbStrategyProvider,
            snapshot.getComposedWorldStateStorage(),
            snapshot.getTrieLogStorage(),
            snapshot,
            caches,
        GLOBAL_VERSION.get());
  }
