...
/**
 * This class intentionally represents an *incompatible* TrieLog implementation. It does not store
 * any data nor support meaningful operations. For example a verkle trielog is not compatible with a
 * merkle trielog
 */
