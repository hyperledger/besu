...
class ParallelTransactionPreprocessing(
    ...
    override fun run(
        ...
        if ((protocolContext!!.worldStateArchive is PathBasedWorldStateProvider)) {
            val parallelizedConcurrentTransactionProcessor =
                ParallelizedConcurrentTransactionProcessor(transactionProcessor)
            ...
            return Optional.of(
                ParallelizedPreProcessingContext(parallelizedConcurrentTransactionProcessor)
            )
        }
