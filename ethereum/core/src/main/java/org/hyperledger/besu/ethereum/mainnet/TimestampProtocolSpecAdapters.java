...
public class TimestampProtocolSpecAdapters {

  final Map<Long, Function<ProtocolSpecBuilder, ProtocolSpecBuilder>> modifiers;

  public TimestampProtocolSpecAdapters(
      final Map<Long, Function<ProtocolSpecBuilder, ProtocolSpecBuilder>> modifiers) {
    this.modifiers = modifiers;
  }

  public static TimestampProtocolSpecAdapters create(
    ...
    entries.put(blockTimestamp, modifier);
    return new TimestampProtocolSpecAdapters(entries);
  }
  ...
  public Function<ProtocolSpecBuilder, ProtocolSpecBuilder> getModifierForBlock(
    ...
    final Long modifier = epochs.floor(blockTimestamp);
