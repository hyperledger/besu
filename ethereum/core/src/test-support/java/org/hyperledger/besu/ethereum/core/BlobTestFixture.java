...
public class BlobTestFixture {
  ...
  public static BlobTriplet createBlobTriplet() {
    byte[] rawMaterial = {};
  ...
  public static BlobsWithCommitments createBlobsWithCommitments(final int blobCount) {
  ...
  private static VersionedHash hashCommitment(final KZGCommitment commitment) {
