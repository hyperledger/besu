...
public class TimestampStreamingProtocolSchedule extends DefaultTimestampSchedule
    implements MilestoneStreamingProtocolSchedule {

  public TimestampStreamingProtocolSchedule(final DefaultTimestampSchedule timestampSchedule) {
    super(timestampSchedule);
  }
