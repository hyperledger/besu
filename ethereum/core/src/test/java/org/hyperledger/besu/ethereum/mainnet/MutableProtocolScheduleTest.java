...
////            config,
////            DEFAULT_CHAIN_ID,
////            ProtocolSpecAdapters.create(1L, modifier),
...
////    assertThat(protocolSchedule.getByBlockHeader(headerWithNumber(0))).isSameAs(spec2);
////  }
//
////  @Test
...
////    protocolSchedule.putMilestone(1, spec2);
////
////    final BlockHeader blockHeader = new
// BlockHeaderTestFixture().number(0L).timestamp(0L).buildHeader();
////    final ProtocolSpec spec = protocolSchedule.getForNextBlockHeader(blockHeader, 1L);
////
////    assertThat(spec).isEqualTo(spec2);
////  }
//
...
////
////    assertThat(protocolSchedule.isOnMilestoneBoundary(headerWithNumber(0))).isEqualTo(true);
////    assertThat(protocolSchedule.isOnMilestoneBoundary(headerWithNumber(1))).isEqualTo(true);
////    assertThat(protocolSchedule.isOnMilestoneBoundary(headerWithNumber(2))).isEqualTo(true);
////    assertThat(protocolSchedule.isOnMilestoneBoundary(headerWithNumber(3))).isEqualTo(false);
////    assertThat(protocolSchedule.isOnMilestoneBoundary(headerWithNumber(4))).isEqualTo(true);
////  }
//
//  private BlockHeader headerWithNumber(final long blockNumber) {
