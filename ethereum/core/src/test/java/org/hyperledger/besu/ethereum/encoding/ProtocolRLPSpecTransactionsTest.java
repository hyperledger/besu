 ...
 * SPDX-License-Identifier: Apache-2.0
 */
public class ProtocolRLPSpecTransactionsTest {
  private static final BerlinRLPSpec berlinRLPFormat = new BerlinRLPSpec();
  ...
  public void encodeFrontierTxNominalCase() {
    ...
    ProtocolRLPSpec.encode(transaction, output);
