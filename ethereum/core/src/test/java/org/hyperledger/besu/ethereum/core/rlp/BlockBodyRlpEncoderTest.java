...
public class BlockBodyRlpEncoderTest {
  @Test
  public void testEncode() {
    ...
    BlockBodyRlpEncoder blockBodyRlpEncoder = new BlockBodyRlpEncoder();
    Bytes actualRlp = blockBodyRlpEncoder.encode(blockBody);
