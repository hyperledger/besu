...
public class TimestampProtocolSpecAdaptersTest {
  ...
  public void specAdapterFindsTheModifierBelowRequestedBlock() {
    ...
    final TimestampProtocolSpecAdapters adapters =
        new TimestampProtocolSpecAdapters(Map.of(3L, firstModifier, 5L, secondModifier));
