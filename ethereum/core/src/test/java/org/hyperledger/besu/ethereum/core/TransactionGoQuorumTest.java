...
public class TransactionGoQuorumTest {
  ...
  private static final RLPFormat rlpFormat = MainnetProtocolSchedule.create().getLatestRLPFormat();
  ...
  public void givenPublicTransaction_assertThatIsGoQuorumFlagIsFalse() {
    Transaction transaction = rlpFormat.decodeTransaction(ETHEREUM_PUBLIC_TX_RLP);
  ...
  public void givenGoQuorumTransactionV37_assertThatIsGoQuorumFlagIsTrue() {
    Transaction transaction = rlpFormat.decodeTransaction(GOQUORUM_PRIVATE_TX_RLP_V37);
  ...
  public void givenGoQuorumTransactionV38_assertThatIsGoQuorumFlagIsTrue() {
    Transaction transaction = rlpFormat.decodeTransaction(GOQUORUM_PRIVATE_TX_RLP_V38);
