...
public class TransactionGoQuorumTest {
  ...
  private static final ProtocolRLPSpec PROTOCOL_RLP_SPEC =
      MainnetProtocolSchedule.create().getLatestRLPFormat();
  ...
  public void givenPublicTransaction_assertThatIsGoQuorumFlagIsFalse() {
    Transaction transaction = PROTOCOL_RLP_SPEC.decodeTransaction(ETHEREUM_PUBLIC_TX_RLP);
  ...
  public void givenGoQuorumTransactionV37_assertThatIsGoQuorumFlagIsTrue() {
    Transaction transaction = PROTOCOL_RLP_SPEC.decodeTransaction(GOQUORUM_PRIVATE_TX_RLP_V37);
  ...
  public void givenGoQuorumTransactionV38_assertThatIsGoQuorumFlagIsTrue() {
    Transaction transaction = PROTOCOL_RLP_SPEC.decodeTransaction(GOQUORUM_PRIVATE_TX_RLP_V38);
