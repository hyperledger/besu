...
public class BlockHeaderRlpEncoderTest {
  @Test
  public void testEncode() {
    ...
    BlockHeaderRlpEncoder blockHeaderRlpEncoder = new BlockHeaderRlpEncoder();
    Bytes actualRlp = blockHeaderRlpEncoder.encode(blockHeader);
