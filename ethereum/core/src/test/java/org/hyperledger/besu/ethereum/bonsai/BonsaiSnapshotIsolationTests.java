...
public class BonsaiSnapshotIsolationTests extends AbstractIsolationTests {
  ...
  public void testSnapshotCloneIsolation() {
    ...
    var isolated = archive.getMutable(genesisState.getBlock().getHeader(), false).get();
    var isolatedClone = archive.getMutable(genesisState.getBlock().getHeader(), false).get();
