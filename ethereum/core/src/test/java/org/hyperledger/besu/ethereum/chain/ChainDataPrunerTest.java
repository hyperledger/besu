...
public class ChainDataPrunerTest {
    ...
    public void singleChainPruning() {
        ...
        gen.setBlockOptionsSupplier(() -> BlockDataGenerator.BlockOptions.create().withGeneratedBlockAccessList());
        ...
        gen.blockSequenceWithAccessList(genesisBlock, 1000)
                .forEach(
                        blockWithBal -> {
                            ...
                            blockWithBal.getBlockAccessList().ifPresent(bal -> {
    ...
    public void forkPruning() {
        ...
        for (int i = 512; i < 527; i++) {
            ...
            if (i > 512) {
                ...
                assertThat(blockchain.getBlockHeader(canonicalChain.get(i - 512).getBlock().getHash())).isEmpty();
                assertThat(blockchain.getBlockHeader(forkChain.get(i - 512).getBlock().getHash())).isEmpty();
            }

            assertThat(blockchain.getBlockHeader(canonicalChain.get(i - 511).getBlock().getHash())).isPresent();
            assertThat(blockchain.getBlockHeader(forkChain.get(i - 511).getBlock().getHash())).isPresent();
        }
    }
    ...
    public void balPruningWithDifferentFrequency() {
        ...
        List<BlockDataGenerator.BlockWithAccessList> blocks = gen.blockSequenceWithAccessList(genesisBlock, 400);
    ...
    public void balPruningWithTwoBatches() {
        ...
        List<BlockDataGenerator.BlockWithAccessList> blocks = gen.blockSequenceWithAccessList(genesisBlock, 500);
        for (BlockDataGenerator.BlockWithAccessList blockWithBal : blocks) {
            final Block blk = blockWithBal.getBlock();
    ...
    public void pruningBeforeBalActivation() {
        ...
        gen.setBlockOptionsSupplier(() -> BlockDataGenerator.BlockOptions.create().withoutGeneratedBlockAccessList());
    ...
    /**
     * Blocking executor for testing purposes.
