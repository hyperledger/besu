...
public class TransactionRLPEncoderTest {
  private static final Bytes FRONTIER_TX_RLP =
      Bytes.fromHexString(
  ...
  private static final Bytes EIP1559_TX_RLP =
      Bytes.fromHexString(
  ...
  private static final Bytes EIP1559_TX_TYPE = Bytes.of((byte) 0x3);

  @Test
  public void encodeEIP1559ToRawBytes() {
    ExperimentalEIPs.eip1559Enabled = true;
    final Transaction transaction =
        TransactionRLPDecoder.eip1559Decoder().decode(RLP.input(EIP1559_TX_RLP));
    assertThat(
            Bytes.concatenate(
                EIP1559_TX_TYPE,
                Bytes.fromHexString(
        ...
        .isEqualTo(transaction.encode());
    ExperimentalEIPs.eip1559Enabled = ExperimentalEIPs.EIP1559_ENABLED_DEFAULT_VALUE;
  }

  @Test
  public void encodeFrontierTxToRawBytes() {
    final Transaction transaction =
        TransactionRLPDecoder.frontierDecoder().decode(RLP.input(FRONTIER_TX_RLP));
    assertThat(FRONTIER_TX_RLP).isEqualTo(transaction.encode());
  }
  ...
  public void encodeFrontierTxNominalCase() {
    ...
    assertThat(FRONTIER_TX_RLP).isEqualTo(output.encoded());
  }
