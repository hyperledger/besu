...
public class TransactionEIP1559Test {
  private final Transaction legacyTransaction =
  ...
  public void givenEIP1559Transaction_assertThatRlpDecodingWorks() {
    ...
    assertThat(eip1559Transaction.getGasPremium()).isEqualByComparingTo(expectedGasPremium);
    assertThat(eip1559Transaction.getFeeCap()).isEqualByComparingTo(expectedFeeCap);
  }
