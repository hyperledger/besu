...
public class TransactionEIP1559Test {
  ...
  private final Wei expectedMinerFee = Wei.of(527);
  ...
  public void givenEIP1559Transaction_assertThatRlpDecodingWorks() {
    ...
    set(legacyTransaction, "minerFee", expectedMinerFee);
    ...
    assertThat(eip1559Transaction.getMinerFee()).hasValue(expectedMinerFee);
