...
public class TStoreEVMOperationTest {
  ...
  public static Object[][] scenarios() {
    ...
    return new Object[][] {
      ...
      {null, new ByteCodeBuilder().tstore(1, 7).tstore(1, 0), State.COMPLETED_SUCCESS, 0, 1},
  ...
  @Parameter() public ByteCodeBuilder contractByteCodeBuilder;
  ...
  public void setUp() {
    ...
    codeExecutor =
        new TestCodeExecutor(
            protocolSchedule, account -> account.setStorageValue(UInt256.ZERO, UInt256.valueOf(0)));
  }
  ...
  public void transientStorageExecutionTest() {
    ...
    if (contractByteCodeBuilder != null) {
      codeExecutor.deployContract(contractAddress, contractByteCodeBuilder.toString());
    }
    for (int i = 0; i < numberOfIterations; i++) {
      final MessageFrame frame =
          codeExecutor.executeCode(byteCodeBuilder.toString(), gasLimit.toLong());
