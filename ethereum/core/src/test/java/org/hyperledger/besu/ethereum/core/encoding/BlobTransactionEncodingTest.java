...
public class BlobTransactionEncodingTest {
  private static Stream<Arguments> provideTypedTransactionBytes() {
    return Stream.of(
        createArgument(
  ...
  private static Arguments createArgument(final String typedTransactionBytes) {
    BytesValueRLPOutput out = new BytesValueRLPOutput();
    out.writeBytes(Bytes.fromHexString(typedTransactionBytes));
