  ...
  public JsonRpcResponse syncResponse(final JsonRpcRequestContext requestContext) {
    ...
    try {
      ...
      throw new InvalidJsonRpcParameters(
          "Invalid engine prepare payload parameter",
          RpcErrorType.INVALID_ENGINE_PREPARE_PAYLOAD_PARAMETER,
          e);
    }
        ...
        .orElseGet(
            () ->
                new JsonRpcErrorResponse(
                    requestId, RpcErrorType.INVALID_ENGINE_PREPARE_PAYLOAD_PARAMETER));
  }
