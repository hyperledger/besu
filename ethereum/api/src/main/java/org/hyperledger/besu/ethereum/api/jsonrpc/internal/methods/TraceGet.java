  ...
  public JsonRpcResponse response(final JsonRpcRequestContext requestContext) {
    ...
    try {
      ...
      throw new InvalidJsonRpcParameters(
          "Invalid transaction has parameter", RpcErrorType.INVALID_TRANSACTION_HASH_PARAMS, e);
    }
    ...
    try {
      ...
      throw new InvalidJsonRpcParameters(
          "Invalid trace numbers parameters", RpcErrorType.INVALID_TRACE_NUMBERS_PARAMS, e);
    }
