...
public class TlsConfiguration {
  ...
  private TlsKeyStoreConfiguration serverKeyStore;

  // optional - trust store for server to verify identify of clients
  private TlsTrustStoreConfiguration clientTrustKeyStore;
  ...
  //optional - default TLS versions already enabled in VertX - SSLv2Hello, TLSv1, TLSv1.1 and TLSv1.2
