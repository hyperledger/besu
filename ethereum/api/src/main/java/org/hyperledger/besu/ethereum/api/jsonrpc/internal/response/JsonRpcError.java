...
public enum JsonRpcError {
  ...
  QUORUM_NO_PRIVATE_FOR(
      -50100, "No privateFor specified in rawTxArgs for quorum raw private transaction."),
  QUORUM_ONLY_STANDARD_MODE_SUPPORTED(
      -50100,
      "Mode other than 'standard' mode defined in rawTxArgs for quorum raw private transaction."),
  QUORUM_LOOKUP_ID_NOT_AVAILABLE(
      -50100, "No lookup id specified in quorum raw private transaction."),
