...
public class EthGetWork implements JsonRpcMethod {
  ...
  public JsonRpcResponse response(final JsonRpcRequest req) {
    ...
    if (solver.isPresent()) {
      ...
      // external mining software aborts if work is not available when eth_getWork is called
      // previous work can be queried by the mining software while new work is readied
