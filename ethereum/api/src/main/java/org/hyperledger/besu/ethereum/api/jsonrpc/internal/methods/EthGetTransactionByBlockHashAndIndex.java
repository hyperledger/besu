  ...
  public JsonRpcResponse response(final JsonRpcRequestContext requestContext) {
    ...
    try {
      ...
      throw new InvalidJsonRpcParameters(
          "Invalid transaction hash parameter", RpcErrorType.INVALID_TRANSACTION_HASH_PARAMS, e);
    }
    final int index;
    try {
      ...
      throw new InvalidJsonRpcParameters(
          "Invalid transaction id parameter", RpcErrorType.INVALID_TRANSACTION_ID_PARAMS, e);
    }
