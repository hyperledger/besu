...
public enum RpcErrorType implements RpcMethodError {
  ...
  INVALID_ACCOUNTS_PARAMS(-32602, "Invalid accounts params"),
  INVALID_ADDRESS_HASH_PARAMS(-32602, "Invalid address hash params"),
  INVALID_ADDRESS_PARAMS(-32602, "Invalid address params"),
  INVALID_AUTH_PARAMS(-32602, "Invalid auth params"),
  INVALID_BLOB_COUNT(-32602, "Invalid blob count (blob transactions must have at least one blob)"),
  ...
  INVALID_CREATE_PRIVACY_GROUP_PARAMS(-32602, "Invalid create privacy group params"),
  ...
  INVALID_ENGINE_PREPARE_PAYLOAD_PARAMETER(-32602, "Invalid engine prepare payload parameter"),
  INVALID_ENODE_PARAMS(-32602, "Invalid enode params"),
  INVALID_EXCESS_BLOB_GAS_PARAMS(-32602, "Invalid excess blob gas params (missing or invalid)"),
  INVALID_EXTRA_DATA_PARAMS(-32602, "Invalid extra data params"),
  INVALID_FILTER_PARAMS(-32602, "Invalid filter params"),
  INVALID_GAS_PRICE_PARAMS(-32602, "Invalid gas price params"),
  INVALID_HASH_RATE_PARAMS(-32602, "Invalid hash rate params"),
  INVALID_ID_PARAMS(-32602, "Invalid ID params"),
  INVALID_IS_TRANSACTION_COMPLETE_PARAMS(-32602, "Invalid is transaction complete params"),
  INVALID_LOG_FILTER_PARAMS(-32602, "Invalid log filter params"),
  INVALID_LOG_LEVEL_PARAMS(-32602, "Invalid log level params (missing or incorrect)"),
  INVALID_MAX_RESULTS_PARAMS(-32602, "Invalid max results params"),
  INVALID_METHOD_PARAMS(-32602, "Invalid method params"),
  INVALID_MIN_GAS_PRICE_PARAMS(-32602, "Invalid min gas price params"),
  INVALID_MIN_PRIORITY_FEE_PARAMS(-32602, "Invalid min priority fee params"),
  ...
  INVAlID_PLUGIN_NAME_PARAMS(-32602, "Invalid plug in name params"),
  INVALID_POSITION_PARAMS(-32602, "Invalid position params"),
  INVALID_POW_HASH_PARAMS(-32602, "Invalid pow hash params"),
  INVALID_PRIVACY_GROUP_PARAMS(-32602, "Invalid privacy group params"),
  INVALID_PRIVATE_FROM_PARAMS(-32602, "Invalid private from params"),
  INVALID_PRIVATE_FOR_PARAMS(-32602, "Invalid private for params"),
  INVALID_REMOTE_CAPABILITIES_PARAMS(-32602, "Invalid remote capabilities params"),
  INVALID_REWARD_PERCENTILES_PARAMETER(-32602, "Invalid reward percentiles params"),
  INVALID_SEALER_ID_PARAMS(-32602, "Invalid sealer ID params"),
  INVALID_STORAGE_KEYS_PARAMS(-32602, "Invalid storage keys params"),
  INVALID_SUBSCRIPTION_PARAMS(-32602, "Invalid subscription params"),
  INVALID_TARGET_GAS_LIMIT_PARAMS(-32602, "Invalid target gas limit params"),
  INVALID_TIMESTAMP_PARAMETER(-32602, "Invalid timestamp params"),
  INVALID_TRACE_CALL_MANY_PARAMS(-32602, "Invalid trace call many params"),
  INVALID_TRACE_NUMBERS_PARAMS(-32602, "Invalid trace numbers params"),
  INVALID_TRACE_TYPE_PARAMS(-32602, "Invalid trace type params"),
  INVALID_TRANSACTION_PARAMS(-32602, "Invalid transaction params (missing or incorrect)"),
  INVALID_TRANSACTION_HASH_PARAMS(-32602, "Invalid transaction hash params"),
  INVALID_TRANSACTION_ID_PARAMS(-32602, "Invalid transaction id params"),
  INVALID_TRANSACTION_INDEX_PARAMS(-32602, "Invalid transaction index params"),
  INVALID_TRANSACTION_LIMIT_PARAMS(-32602, "Invalid transaction limit params"),
  INVALID_TRANSACTION_TRACE_PARAMS(-32602, "Invalid transaction trace params"),
  INVALID_VERSIONED_HASH_PARAMS(-32602, "Invalid versioned hash params"),
  INVALID_VOTE_TYPE_PARAMS(-32602, "Invalid vote type params"),
  INVALID_WITHDRAWALS_PARAMS(-32602, "Invalid  withdrawals"),
