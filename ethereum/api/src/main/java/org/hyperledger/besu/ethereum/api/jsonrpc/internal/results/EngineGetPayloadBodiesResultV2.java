...
public class EngineGetPayloadBodiesResultV2 {

  private final List<PayloadBody> payloadBodies;

  public EngineGetPayloadBodiesResultV2() {
    this.payloadBodies = Collections.<PayloadBody>emptyList();
  }

  public EngineGetPayloadBodiesResultV2(final List<PayloadBody> payloadBody) {
  ...
  public static class PayloadBody {
    ...
    public PayloadBody(final BlockBody blockBody, final String blockAccessList) {
      this.transactions =
