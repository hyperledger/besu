...
public class DomainObjectDecodeUtils {
  ...
  public static Transaction decodeRawTransaction(
      final String rlp, final ProtocolRLPSpec protocolRlpSpec)
      throws InvalidJsonRpcRequestException {
    try {
      return protocolRlpSpec.decodeTransaction(RLP.input(Bytes.fromHexString(rlp)));
