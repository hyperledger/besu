...
public class DomainObjectDecodeUtils {
  ...
  public static TypicalTransaction decodeRawTransaction(final String rlp)
      throws InvalidJsonRpcRequestException {
    try {
      return TransactionRLPDecoder.decodeTransaction(RLP.input(Bytes.fromHexString(rlp)));
