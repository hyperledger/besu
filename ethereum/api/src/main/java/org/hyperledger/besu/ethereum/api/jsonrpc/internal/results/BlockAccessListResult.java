...
public class BlockAccessListResult {
  ...
  private final BlockAccessListParameter blockAccessList;

  public BlockAccessListResult(
      final String balHash, final BlockAccessListParameter blockAccessList) {
  ...
  public BlockAccessListParameter getBlockAccessList() {
