...
public abstract class AbstractEthSendRawTransaction implements JsonRpcMethod {
  ...
  protected final Supplier<TransactionPool> transactionPool;

  public AbstractEthSendRawTransaction(final TransactionPool transactionPool) {
    this(Suppliers.ofInstance(transactionPool), false);
  }

  public AbstractEthSendRawTransaction(
