...
public class EngineForkchoiceUpdatedV2Test {
  ...
  private EngineForkchoiceUpdatedV2 method;
  ...
  @Mock private TimestampSchedule protocolSchedule;
  ...
  public void before() {
    ...
    when(protocolSchedule.getByTimestamp(anyLong())).thenReturn(Optional.of(protocolSpec));
    this.method =
  ...
  public void shouldReturnInvalidIfWithdrawalsIsNotNull_WhenWithdrawalsProhibited() {
    ...
    assertInvalidForkchoiceState(resp, JsonRpcError.INVALID_PARAMS);
    verify(engineCallListener, times(1)).executionEngineCalled();
  }
  ...
  private EngineUpdateForkchoiceResult assertSuccessWithPayloadForForkchoiceResult(
      ...
      final Optional<EnginePayloadAttributesParameterV2> payloadParam,
  ...
  private JsonRpcResponse resp(
    ...
    return method.response(
        new JsonRpcRequestContext(
            new JsonRpcRequest(
                "2.0",
                RpcMethod.ENGINE_FORKCHOICE_UPDATED_V2.getMethodName(),
