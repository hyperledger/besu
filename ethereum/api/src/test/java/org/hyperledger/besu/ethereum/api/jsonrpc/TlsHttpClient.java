...
public class TlsHttpClient {
  ...
  private TlsHttpClient(final OkHttpClient client) {
    this.client = client;
  }
  ...
  public static final class TlsHttpClientBuilder {
    ...
    public TlsHttpClientBuilder withBesuCertificate(SelfSignedP12Certificate besuCertificate) {
      this.besuCertificate = besuCertificate;
      return this;
    }

    public TlsHttpClientBuilder withOkHttpCertificate(SelfSignedP12Certificate okHttpCertificate) {
      this.okHttpCertificate = okHttpCertificate;
      return this;
    }

    public TlsHttpClient build() {
      return new TlsHttpClient(buildHttpClient());
    }
