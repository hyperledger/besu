...
public class DebugTraceCallJsonRpcHttpBySpecTest extends AbstractJsonRpcHttpBySpecTest {
  ...
  public static Object[][] specs() {
    return AbstractJsonRpcHttpBySpecTest.findSpecFiles(new String[] {"debug/traceCall"});
  }
}
