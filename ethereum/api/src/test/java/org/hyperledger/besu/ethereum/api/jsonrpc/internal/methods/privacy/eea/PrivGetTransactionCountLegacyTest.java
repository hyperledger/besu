...
public class PrivGetTransactionCountLegacyTest {

  private final PrivateNonceProviderLegacy nonceProvider = mock(PrivateNonceProviderLegacy.class);
  ...
  public void setup() {
    ...
    request = new JsonRpcRequest("2.0", "priv_getTransactionCountLegacy", jsonBody);
  }

  @Test
  public void validRequestProducesExpectedNonce() {
    final long reportedNonce = 8L;
    final PrivGetTransactionCountLegacy method =
        new PrivGetTransactionCountLegacy(new JsonRpcParameter(), nonceProvider);
