...
public class EngineNewPayloadV4Test extends EngineNewPayloadV3Test {
  ...
  //    final List<Request> depositRequests = null;
  ...
  //    final List<Request> depositRequestsParam = List.of(DEPOSIT_PARAM_1);
  ...
  //    final List<Request> depositRequests = List.of();
  //    lenient().when(protocolSpec.getRequestsValidator()).thenReturn(new RequestsValidator());
  //
  //    var resp =
  //        resp(
  //            mockEnginePayload(
