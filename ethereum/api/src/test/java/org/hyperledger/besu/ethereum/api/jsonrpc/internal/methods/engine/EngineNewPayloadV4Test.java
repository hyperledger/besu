...
public class EngineNewPayloadV4Test extends EngineNewPayloadV3Test {
  ...
  public void shouldReturnValidIfDepositsIsNull_WhenDepositsProhibited() {
    ...
    var resp =
        resp(mockEnginePayload(mockHeader, Collections.emptyList(), null, deposits, null, null));
  ...
  public void shouldReturnValidIfDepositsIsNotNull_WhenDepositsAllowed() {
    ...
    var resp =
        resp(
            mockEnginePayload(
                mockHeader, Collections.emptyList(), null, depositsParam, null, null));
  ...
  public void shouldReturnValidIfExitsIsNotNull_WhenExitsAllowed() {
    ...
    var resp =
        resp(
            mockEnginePayload(
                mockHeader, Collections.emptyList(), null, null, validatorExitsParams, null));
