...
public class EthGetBlockAccessListByBlockHashTest {
  private final BlockDataGenerator blockDataGenerator = new BlockDataGenerator();
  private EthGetBlockAccessListByBlockHash method;
  ...
  public void setUp() {
    ...
    method = new EthGetBlockAccessListByBlockHash(blockchainQueries);
  }

  @Test
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("eth_getBlockAccessListByBlockHash");
  }
  ...
  public void shouldReturnBlockAccessListForValidBlockHash() {
    ...
    final JsonRpcResponse response = requestBlockAccessList(blockHash);
  ...
  @Test
  public void shouldThrowInvalidJsonRpcParametersForInvalidBlockHash() {
    final JsonRpcRequestContext requestContext =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", method.getName(), new Object[] {"invalid-hash"}));
  ...
  @Test
  public void shouldThrowInvalidJsonRpcParametersForNullParameter() {
    final JsonRpcRequestContext requestContext =
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", method.getName(), new Object[] {null}));

    assertThatThrownBy(() -> method.response(requestContext))
        .isInstanceOf(InvalidJsonRpcParameters.class);
  }

  private JsonRpcResponse requestBlockAccessList(final Hash blockHash) {
    return method.response(
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", method.getName(), new Object[] {blockHash})));
  }
}
